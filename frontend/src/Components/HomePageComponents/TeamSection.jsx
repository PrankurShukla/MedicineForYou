            ...
            <div className="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
              <div className="member">
                <div className="member-img">
                  <img src="./assets/img/team/Photo.jpg" className="img-fluid" alt=""/>
                  <div className="social">
                    <a href="https://github.com/Prankur Shukla" target='_blank'><i className="bi bi-github"></i></a>
                    <a href="https://in.linkedin.com/in/prankur-shukla-07bb18241/" target='_blank'><i className="bi bi-linkedin"></i></a>
                  </div>
                </div>
                <div className="member-info">
                  <h4>Prankur Shukla</h4>
